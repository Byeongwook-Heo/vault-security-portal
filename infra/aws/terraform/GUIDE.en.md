...
This Terraform stack provisions a dedicated portal environment or uses explicitly supplied existing networking.
...
To use existing AWS networking, configure:
